...
pref("extensions.system-monitor@clear-code.com.cpu-usage.color.gradientEndAlpha", "0.8");
...
pref("extensions.system-monitor@clear-code.com.memory-usage.color.gradientEndAlpha", "0.8");
